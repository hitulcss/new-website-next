...
function TermCondition() {
  return (
    <div className="container flex flex-col h-full bg-gray-100 text-gray-600 px-5 py-3">
      <h1 className="text-3xl font-bold">Terms & Conditions</h1>
      <hr className="border-1 border-gray-500"></hr>
      <h2 className="text-2xl font-bold py-2">Terms & Conditions</h2>
      <p>Welcome to SD Campus!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of SD Campus's Website, located at https://www.sdcampus.com/.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use SD Campus if you do not agree to take
      ...
      <h2 className="text-2xl font-bold py-4">Cookies</h2>
      <p>
        We employ the use of cookies. By accessing SD Campus, you agreed to use
        cookies in agreement with the SD Campus's Privacy Policy.
      </p>
      <p>
      ...
      <h2 className="text-2xl font-bold py-4">License</h2>
      <p>
        Unless otherwise stated, SD Campus and/or its licensors own the
        intellectual property rights for all material on SD Campus. All
        intellectual property rights are reserved. You may access this from SD
        Campus for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>
      <p>You must not:</p>
      <ul className="px-6 text-x">
        <li>Republish material from SD Campus</li>
        <li>Sell, rent or sub-license material from SD Campus</li>
        <li>Reproduce, duplicate or copy material from SD Campus</li>
        <li>Redistribute content from SD Campus</li>
      </ul>
      <p>
        You hereby grant SD Campus a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your
        Comments in any and all forms, formats or media.
      </p>
      <h2 className="text-2xl font-bold py-4">Hyperlinking to our Content</h2>
      <p>
      ...
      <p>
        ...
        the hyperlink compensates the absence of SD Campus; and (d) the link is
      ...
      <p>
        ...
        e-mail to SD Campus. Please include your name, your organization name,
      ...
      <p className="py-4">
        No use of SD Campus's logo or other artwork will be allowed for linking
        absent a trademark license agreement.
      </p>
      <h2 className="text-2xl font-bold py-4 font-black-500">iFrames</h2>
      <p>
        Without prior approval and written permission, you may not create frames
        around our Webpages that alter in any way the visual presentation or
        appearance of our Website.
      </p>
      <h2 className="text-2xl font-bold py-4">Content Liability</h2>
      <p>
      ...
      <h2 className="text-2xl py-4 font-bold">Reservation of Rights</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold py-4">Reservation of Rights</h2>
      <p>
        We reserve the right to request that you remove all links or any
        particular link to our Website. You approve to immediately remove all
        links to our Website upon request. We also reserve the right to amen
