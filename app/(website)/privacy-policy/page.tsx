...
function PrivacyPolicy() {
  return (
    <div className="flex flex-col h-full bg-gray-100 text-gray-600 px-5 py-5">
      ...
      <h3 className="text-x font-bold py-3">Interpretation</h3>
      <p>
      ...
      <h3 className="text-x font-bold py-3">Definitions</h3>
      ...
      <p>
        Application refers to SD Campus, the software program provided by the
        Company.
      </p>
      <p>
      ...
      <h3 className="text-x font-bold py-3">Types of Data Collected</h3>
      <h4 className="font-bold">Personal Data</h4>
      <p>
        We collect certain information about You to help us serve You better.
        The information collected by Us is of the following nature:
      </p>
      <ul>
        <li>1. Name</li>
        ...
        <li>
          5. Other information about the service address which You give Us
        </li>
        ...
        <li>
          10. Demographic information such as postcode, preferences and
          interests
        </li>
        <li>
          11. Any other personal information which you give us in connection
          while booking a service or is relevant to customer surveys and/or
          offers.
        </li>
      </ul>
      <h4 className="text-x font-bold py-4">Usage Data</h4>
      ...
      <p>
        To provide and maintain our Serviceincluding to monitor the usage of our
        Service.
      </p>
      <p>
      ...
      <h4 className="text-xl font-bold">Disclosure of Your Personal Data</h4>
      ...
      <h4 className="text-2xl font-bold">Security of Your Personal Data</h4>
      <p>
      ...
      <p>
        To register on the website/app, you must meet the Age Requirements
        specified hereinbelow. If you are a ‘Minor’ or ‘Child’, i.e., an
        individual who does not meet the Age Requirements, then you may not
        register on the website/app, and only your parent can register on your
        behalf, agree to all website/app Terms and Another part of our priority
        ...
        guide their online activity. app does not knowingly collect any Personal
        Identifiable Information from children under the age of 13. If you think
        that your child provided this kind of information on our website/app, we
        strongly encourage you to contact us immediately and we will do our best
        efforts to promptly remove such information from our records. If you are
        a parent / legal guardian and you are aware that your child has provided
        us with personal information without your consent, please contact us at
        info@sdempire.co.in If your Child faces bullying, abuse or harassment
        while availing our Services, please contact us at info@sdempire.co.in
      </p>
      <p>
      ...
      <h2 className="text-2xl font-bold">
        DND (Do Not Disturb) / NDNC (National Do Not Call)
      </h2>
      <p>
        By using the Website and/or registering yourself at sdcampus.com you
        ...
        irrespective of the fact if you have also registered yourself under DND
        or DNC or NCPR service, you still authorize us to give you a call from
        sdcampus.com for the above mentioned purposes till 365 days of your
        registration with us.
      </p>
      <h2 className="text-2xl font-bold">Refund Policy</h2>
      <p>
        At SD Campus, we want our customers to be fully satisfied with their
        purchases. However, we do have a no refund policy for most products and
        services.
      </p>
      <h5 className="text-xl text-gray-500 font-bold">
        Online Batches and Other Services
      </h5>
      <p>
        All online batches, coaching services, and other intangible products are
        non-refundable after purchase. We do not provide refunds on these
        services.
      </p>
      <h5 className="text-xl text-gray-500 font-bold">Physical Products</h5>
      <p>
        Physical products like books and accessories are eligible for refund or
        replacement only if:
      </p>
      <ul className="px-6">
        <li>
          The item received is damaged or defective. A replacement will be
          provided.
        </li>
        <li>
          The item is lost by the courier partner during transit. A replacement
      ...
      <h5 className="text-xl text-gray-500 font-bold">Incorrect Purchases</h5>
      <p>
        if you purchase a product or batch by mistake, you can request to change
        it to another batch or product of the same value. This change request
        must be made within 10 days of the original purchase.
      </p>
      <h5 className="text-xl text-gray-500 font-bold">Changes/Cancellations</h5>
      <p>
        We do not provide refunds if you change your mind or wish to cancel an
        order after purchase. Please review products carefully before ordering.
      </p>
      <p>
        We hope this refund policy provides clarity to our customers. Please
        reach out with any other questions. We aim to resolve any issues to your
        satisfaction.
      </p>
      ...
      <p>
        By email:
        <a href="contact@sdempire.co.in">
          <u>contact@sdempire.co.in</u>
        </a>
      </p>
      <p>
        By visiting this page on our website:
        <a href="https://www.sdcampus.com/">
          <u>https://www.sdcampus.com</u>
        </a>
      </p>
      <p>
        By phone number:
        <a href="+917428394519">+917428394519</a>
      </p>
    </div>
  );
}
